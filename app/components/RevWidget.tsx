...
const reviews = [
  {
    ...
    review:
      "Fantastic Company! Really organised from start to finish. Said they would arrive Monday morning and be finished by the end of the week and they were. They organised everything from ripping out the old bathroom, plastering, tiling, plumbing, fitting and painting. I would highly recommend to anyone that wants a new bathroom or kitchen!",
  },
  {
    name: "Jean Morriss",
    service: "Walk in Showers & Wet Rooms",
    review:
      "Alex recently fitted a new shower unit in our bathroom, he has done a fantastic job, extremely tidy & friendly, would highly recommend",
  },
  {
    name: "Allen Tortoishell",
    service: "Bathroom Renovation & Design",
    review:
      "Just had my bathroom refurb done by Alex and his team along with Simon from Blythe ceramics who I’ve used before what can I say 10/10 absolutely fantastic will be using them again for future projects Alex is fantastic from start to finish going above and beyond to make sure the job is going along and communicating all the way 100% recommend them",
  },
];
